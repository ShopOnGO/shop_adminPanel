...
type UserServiceClient interface {
	...
	FindUserByEmail(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) FindUserByEmail(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	FindUserByEmail(context.Context, *EmailRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) FindUserByEmail(context.Context, *EmailRequest) (*UserResponse, error) {
...
func _UserService_FindUserByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).FindUserByEmail(ctx, req.(*EmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
